...
<?php $__env->startSection('title', 'إدارة الأجهزة'); ?>
<?php $__env->startSection('breadcrumb-title', 'إدارة الأجهزة'); ?>
    ...
    <div class="row">
        <div class="col-lg-3 col-12">
            <div class="small-box bg-info">
                <div class="inner"><h3><?php echo e($stats['total'] ?? 0); ?></h3><p>إجمالي الأجهزة</p></div>
                <div class="icon"><i class="fas fa-microchip"></i></div>
            </div>
        </div>
        <div class="col-lg-3 col-12">
            <div class="small-box bg-success">
                <div class="inner"><h3><?php echo e($stats['active'] ?? 0); ?></h3><p>أجهزة نشطة</p></div>
                <div class="icon"><i class="fas fa-check-circle"></i></div>
            </div>
        </div>
        <div class="col-lg-3 col-12">
            <div class="small-box bg-warning">
                <div class="inner"><h3><?php echo e($stats['working'] ?? 0); ?></h3><p>تعمل بكفاءة</p></div>
                <div class="icon"><i class="fas fa-charging-station"></i></div>
            </div>
        </div>
        <div class="col-lg-3 col-12">
            <div class="small-box bg-danger">
                <div class="inner"><h3><?php echo e($stats['maintenance'] ?? 0); ?></h3><p>تحت الصيانة</p></div>
...
$(document).ready(function() {
    ...
    var table = $('#devicesTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('admin.devices.index')); ?>",
            data: function(d) {
    ...
    $('#addForm').submit(function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('admin.devices.store')); ?>",
            method: 'POST',
            data: $(this).serialize(),
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\updating lum\resources\views/backend/devices/index.blade.php ENDPATH**/ ?>