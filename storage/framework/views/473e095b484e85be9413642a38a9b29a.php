    ...
    <div class="container-fluid">
        ...
        <?php if(session('error')): ?>
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <i class="fas fa-times-circle ml-1"></i> <?php echo e(session('error')); ?>
...
$(document).ready(function () {
    ...
    var table = $('#governorates-table').DataTable({
        ...
        ajax: {
            url: "<?php echo e(route('admin.governorates.index')); ?>",
            type: 'GET',
            error: function () {
...
buttons: [],
    ...
    $('#btnSaveGovernorate').click(function () {
        ...
        $.ajax({
            url: "<?php echo e(route('admin.governorates.store')); ?>",
            method: 'POST',
    ...
    $(document).on('click', '.edit-governorate', function () {
        ...
        $.ajax({
            url: "<?php echo e(url('admin/governorates')); ?>/" + id,
            method: 'GET',
...
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\updating lum\resources\views/backend/governorates/index.blade.php ENDPATH**/ ?>