...
<?php $__env->startSection('title', 'حركة المخزون'); ?>
<?php $__env->startSection('breadcrumb-title', 'إدارة المخازن'); ?>
        ...
        <div class="card card-outline card-primary">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="<?php echo e(route('admin.inventory_transactions.create')); ?>" class="btn btn-primary btn-sm">
...
<?php $__env->startPush('custom-js'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#transactions-table').DataTable({
                ...
                order: [[1, 'desc']],
                ajax: {
                    url: "<?php echo e(route('admin.inventory_transactions.index')); ?>",
                    type: "GET",
                    data: function(d) {
    ...
    width: '140px'
            ...
            $(document).on('click', '.view-transaction', function() {
                ...
                $.ajax({
                    url: "<?php echo e(url('admin/inventory_transactions')); ?>/" + id + "/json",
                    type: 'GET',
            ...
            $(document).on('click', '.delete-transaction', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "<?php echo e(url('admin/inventory_transactions')); ?>/" + id,
                            type: 'DELETE',
                            data: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\updating lum\resources\views/backend/inventory_transactions/index.blade.php ENDPATH**/ ?>