...
<?php $__env->startSection('title', 'إدارة التوزيعات'); ?>
...
<?php $__env->startPush('custom-js'); ?>
    ...
    $(document).ready(function() {
        ...
        function displayTotalsRow(totals) {
            ...
            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                totalRow += `<td class="text-center font-weight-bold">${(totals.product_totals[<?php echo e($product->id); ?>] || 0).toLocaleString()}</td>`;
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        table = $('#distribution_allocations_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(route('admin.department_allocations.index')); ?>",
                type: "GET",
                data: function (d) {
            ...
            columns: [
                ...
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                { 
                    data: 'prod_<?php echo e($product->id); ?>', 
                    name: 'prod_<?php echo e($product->id); ?>',
        ...
        $('#addDistributionForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.department_allocations.store')); ?>",
                type: "POST",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\updating lum\resources\views/backend/department_allocations/index.blade.php ENDPATH**/ ?>