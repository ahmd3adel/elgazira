...
$(document).on('click', '.edit-governorate', function() {
    ...
    $.ajax({
        url: "<?php echo e(url('admin/governorates')); ?>/" + id + "/edit",
        method: 'GET',
...
$('.dataTables_filter input').addClass('form-control').attr('placeholder', '🔍 ابحث عن محافظة...');<?php /**PATH C:\xampp\htdocs\updating lum\resources\views/backend/suppliers/partials/scripts/modals.blade.php ENDPATH**/ ?>