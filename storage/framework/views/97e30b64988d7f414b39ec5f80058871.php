...
$('#department_id').on('change', function() {
    ...
    if (departmentId) {
        $.ajax({
            url: "<?php echo e(route('admin.getSchoolsByDepartment')); ?>",
            type: "GET",
...
});<?php /**PATH C:\xampp\htdocs\updating lum\resources\views/backend/distributions/partials/scripts/modals.blade.php ENDPATH**/ ?>