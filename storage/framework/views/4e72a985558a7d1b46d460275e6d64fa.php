...
<?php $__env->startSection('breadcrumb-title', 'إدارة المدارس'); ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-6">
                <div class="small-box bg-success">
                    <div class="inner">
                        <h3><?php echo e($stats['elementary'] ?? 0); ?></h3>
                        <p>مدارس ابتدائي</p>
                    </div>
                    <div class="icon">
            ...
            <div class="col-lg-3 col-6">
                <div class="small-box bg-warning">
                    <div class="inner">
                        <h3><?php echo e($stats['middle'] ?? 0); ?></h3>
                        <p>مدارس اعدادي</p>
                    </div>
                    <div class="icon">
            ...
            <div class="col-lg-3 col-6">
                <div class="small-box bg-danger">
                    <div class="inner">
                        <h3><?php echo e($stats['kindergarten'] ?? 0); ?></h3>
                        <p>حضانات</p>
                    </div>
                    <div class="icon">
...
$(document).ready(function() {
    ...
    var table = $('#schools-table').DataTable({
        ...
        scrollX: true,
        ajax: {
            url: "<?php echo e(route('admin.schools.index')); ?>",
            type: "GET",
        },
        columns: [
    ...
    $('#addSchoolForm').on('submit', function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('admin.schools.store')); ?>",
            method: 'POST',
            data: $(this).serialize(),
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\updating lum\resources\views/backend/schools/index.blade.php ENDPATH**/ ?>