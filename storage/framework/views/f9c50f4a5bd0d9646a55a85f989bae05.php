<script>
  ...
  table = $('#inventorytable').DataTable({
    ...
    autoWidth: false,
    ajax: {
        url: "<?php echo e(route('admin.inventories.index')); ?>",
        type: "GET",
    },
...
<?php /**PATH C:\xampp\htdocs\updating lum\resources\views/backend/inventories/partials/scripts/datatable.blade.php ENDPATH**/ ?>