...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid px-2 px-md-3">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-12 mb-3">
                <div class="small-box bg-info" style="cursor: pointer;" onclick="scrollToTable()">
                    <div class="inner">
                        <h3><?php echo e(number_format($totalSummary['grand_total_quantity'] ?? 0)); ?></h3>
            ...
            <div class="col-lg-3 col-md-6 col-12 mb-3">
                <div class="small-box bg-success" style="cursor: pointer;" onclick="scrollToTable()">
                    <div class="inner">
                        <h3><?php echo e(number_format($totalSummary['total_shipments'] ?? 0)); ?></h3>
                        <p>إجمالي الشحنات</p>
                    </div>
                    <div class="icon">
            ...
            <div class="col-lg-3 col-md-6 col-12 mb-3">
                <div class="small-box bg-warning" style="cursor: pointer;" onclick="scrollToTable()">
                    <div class="inner">
                        <h3><?php echo e(number_format($totalSummary['total_samples'] ?? 0)); ?></h3>
                        <p>إجمالي العينات</p>
                    </div>
                    <div class="icon">
            ...
            <div class="col-lg-3 col-md-6 col-12 mb-3">
                <div class="small-box bg-secondary" style="cursor: pointer;"
                    ...
                    <div class="inner">
                        <h3><?php echo e(number_format($warehouses->count() ?? 0)); ?></h3>
                        <p>المخازن النشطة</p>
                    </div>
                    <div class="icon">
                    ...
                    <div class="small-box-footer">
                        <i class="fas fa-building"></i> <?php echo e(number_format(count($productsMatrix))); ?> منتج
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <span class="badge badge-primary"><?php echo e(count($supplierSummary)); ?> مورد</span>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <?php $__empty_1 = true; $__currentLoopData = $supplierSummary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="col-lg-3 col-md-4 col-6 mb-3">
                                    <div class="info-box shadow-sm supplier-mini-card"
                                        onclick="filterBySupplier(<?php echo e($supplier['supplier_id']); ?>, '<?php echo e(addslashes($supplier['supplier_name'])); ?>')">
                                        <div class="info-box-icon bg-primary rounded">
                                            <i class="fas fa-store"></i>
                                        </div>
                                        <div class="info-box-content">
                                            <span
                                                class="info-box-text font-weight-bold"><?php echo e(Str::limit($supplier['supplier_name'], 25)); ?></span>
                                            <span class="info-box-number"><?php echo e(number_format($supplier['total_quantity'])); ?>

                                                <small>كرتونة</small></span>
                                            <div class="mt-1">
                                                <small class="text-muted">
                                                    <i class="fas fa-ship"></i> <?php echo e($supplier['shipment_count']); ?> شحنة
                                                    &nbsp;|&nbsp;
                                                    <i class="fas fa-chart-line"></i>
                                                    <?php echo e(number_format($supplier['avg_per_shipment'])); ?> ك/شحنة
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="info-box bg-gradient-info shadow-sm" onclick="resetFilter()"
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span class="info-box-number text-white">
                                                ...
                                                <?php echo e(number_format($totalSummary['total_shipments'] ?? 0)); ?>
                                ...
                                <div class="col-lg-3 col-md-4 col-6 mb-3">
                                    <div class="info-box bg-gradient-dark shadow-sm">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span
                                                class="info-box-number text-white"><?php echo e(number_format($totalSummary['grand_total_quantity'] ?? 0)); ?></span>
                                            <div class="mt-1">
                                                <small class="text-white-50">
                                                    <i class="fas fa-trucks"></i>
                                                    <?php echo e(number_format($totalSummary['total_shipments'] ?? 0)); ?> شحنة
                                                    &nbsp;|&nbsp;
                                                    <i class="fas fa-flask"></i>
                                                    <?php echo e(number_format($totalSummary['total_samples'] ?? 0)); ?> عينة
                                                </small>
                                            </div>
                                        </div>
                                    </div>
        ...
        <?php if(count($samplesDistribution) > 0): ?>
            <div class="row mb-3">
                <div class="col-12">
                    <div class="alert alert-warning samples-bar mb-0">
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                <?php $__currentLoopData = $samplesDistribution; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sample): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="badge badge-light p-2">
                                        <i class="fas fa-warehouse text-info"></i>
                                        <?php echo e($sample['warehouse_name']); ?>:
                                        <strong
                                            class="text-warning"><?php echo e(number_format($sample['samples_count'])); ?></strong>
                                    </span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <span class="badge badge-success p-2">
                                    <i class="fas fa-chart-line"></i>
                                    الإجمالي: <strong><?php echo e(number_format($totalSummary['total_samples'] ?? 0)); ?></strong>
                                </span>
                            </div>
                        </div>
                    </div>
        ...
        <?php if($warehouses->count() > 0 && count($productsMatrix) > 0): ?>
            <div class="row mb-3">
                <div class="col-12">
                                ...
                                <table class="table table-bordered table-hover matrix-table mb-0"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <?php $__currentLoopData = $productsMatrix; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <th style="min-width: 100px; text-align: center;">
                                                    <?php echo e(\Illuminate\Support\Str::limit($product['name'] ?? 'منتج', 20)); ?>

                                                    <small
                                                        class="d-block text-white-50"><?php echo e($product['sku'] ?? ''); ?></small>
                                                </th>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php $__currentLoopData = $warehouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                <th style="position: sticky; right: 0; background: #f8f9fa;">
                                                    <i class="fas fa-building ml-1 text-primary"></i> <?php echo e($warehouseName); ?>

                                                    <?php if($warehouseCode): ?>
                                                        <small class="d-block text-muted"><?php echo e($warehouseCode); ?></small>
                                                    <?php endif; ?>
                                                </th>
                                                <?php $rowTotal = 0; ?>
                                                <?php $__currentLoopData = $productsMatrix; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productId => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                                    ...
                                                    <td class="text-center">
                                                        <?php if($quantity > 0): ?>
                                                            <span
                                                                class="badge badge-<?php echo e($badgeClass); ?> badge-pill px-3 py-2"><?php echo e(number_format($quantity)); ?></span>
                                                        <?php else: ?>
                                                ...
                                                <td class="text-center font-weight-bold bg-light">
                                                    <?php echo e(number_format($rowTotal)); ?></td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tbody>
                                    <tfoot>
                                        <tr style="background: #e9ecef;">
                                            ...
                                            <?php $__currentLoopData = $productsMatrix; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productId => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <th class="text-center">
                                                    <?php if($colTotals[$productId] > 0): ?>
                                                        <span
                                                            class="badge badge-primary badge-pill px-3 py-2"><?php echo e(number_format($colTotals[$productId])); ?></span>
                                                    <?php else: ?>
                                                        <span class="text-muted">—</span>
                                                    <?php endif; ?>
                                                </th>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <th class="text-center bg-success text-white"><?php echo e(number_format($grandTotal)); ?>
    ...
    <div class="modal fade" id="addReceivingOrderModal" tabindex="-1">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content shadow-lg border-0">
                ...
                <form id="receivingForm" method="POST" action="<?php echo e(route('admin.receiving_orders.store')); ?>"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="production_date" id="production_date"
                                    class="form-control shadow-sm" value="<?php echo e(date('Y-m-d')); ?>">
                            </div>
        ...
        $(document).ready(function() {
            ...
            table = $('#receiving-orders-table').DataTable({
                ...
                autoWidth: false,
                 pageLength: 100,
                ajax: {
                    url: "<?php echo e(route('admin.receiving_orders.index')); ?>",
                    type: "GET"
                },
  columns: [
    { 
    ...
    { 
        ...
        className: 'text-center'
            ...
            $(document).on('click', '.edit-receiving-order', function() {
                ...
                $.ajax({
                    url: "<?php echo e(url('admin/receiving_orders')); ?>/" + id + "/edit",
                    method: 'GET',
        ...
        function filterBySupplier(supplierId, supplierName) {
            table.ajax.url("<?php echo e(route('admin.receiving_orders.index')); ?>?supplier_id=" + supplierId).load();
            Swal.fire({
                title: 'تم التصفية',
        ...
        function resetFilter() {
            table.ajax.url("<?php echo e(route('admin.receiving_orders.index')); ?>").load();
            Swal.fire({
                title: 'تم',
        ...
        $('#submitBtn').click(function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.receiving_orders.store')); ?>",
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        $('#btnUpdateReceivingOrder').click(function() {
            ...
            $.ajax({
                url: "<?php echo e(url('admin/receiving_orders')); ?>/" + id,
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        function fetchExpiryDate(productionDate, productId, callback) {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.receiving_orders.calculate-expiry')); ?>",
                method: 'GET',
                data: {
        ...
        $('#removeReceiptBtn').click(function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('admin/receiving_orders')); ?>/" + id + "/remove-receipt",
                        method: 'DELETE',
                        data: {
...
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\updating lum\resources\views/backend/receiving_orders/index.blade.php ENDPATH**/ ?>