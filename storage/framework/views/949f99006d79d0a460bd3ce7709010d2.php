    ...
    $(function() {
        table = $('#distribution-orders-table').DataTable({
            ...
            ajax: {
                ...
                url: "<?php echo e(route('admin.distribution_orders.index')); ?>",
                type: "GET",
            },
...
columns: [
    ...
    { data: 'prod_<?php echo e($product->id); ?>', name: 'prod_<?php echo e($product->id); ?>', orderable: false, searchable: false },
...
});<?php /**PATH C:\xampp\htdocs\updating lum\resources\views/backend/distributions/partials/scripts/datatable.blade.php ENDPATH**/ ?>