...
@push('custom-css')
    {{-- يفضل مستقبلاً نقل هذه الملفات لمجلد خاص بـ governorates --}}
    @include('backend.governorates.partials.styles')
    <style>
        .card-title i {
            color: #17a2b8;
        }
        ...
        <div class="card card-outline card-info"> {{-- لون info (أزرق) مناسب للمناطق الجغرافية --}}
            <div class="card-header">
                ...
                <div class="card-tools d-flex">
                    @include('backend.governorates.partials.export-buttons')
            ...
            <div class="card-body">
                @include('backend.governorates.partials.table')
            </div>
        </div>
    </div>

    {{-- المودالات الخاصة بالمحافظات --}}
    @include('backend.governorates.partials.modals.add')
    @include('backend.governorates.partials.modals.edit')
@endsection
...
@push('custom-js')
    ...
    @include('backend.governorates.partials.scripts.datatable')
    @include('backend.governorates.partials.scripts.modals')
    @include('backend.governorates.partials.scripts.exports')
