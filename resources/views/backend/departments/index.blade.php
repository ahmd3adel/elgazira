...
@push('custom-css')
    {{-- يفضل مستقبلاً نقل هذه الملفات لمجلد خاص بـ departments --}}
    @include('backend.departments.partials.styles')
    <style>
        .card-title i {
            color: #17a2b8;
        }
        ...
        <div class="card card-outline card-info"> {{-- لون info (أزرق) مناسب للمناطق الجغرافية --}}
            <div class="card-header">
                ...
                <div class="card-tools d-flex">
                    @include('backend.departments.partials.export-buttons')
            ...
            <div class="card-body">
                @include('backend.departments.partials.table')
            </div>
        </div>
    </div>

    {{-- المودالات الخاصة بالمحافظات --}}
    @include('backend.departments.partials.modals.add')
    @include('backend.departments.partials.modals.edit')
@endsection
...
@push('custom-js')
    ...
    @include('backend.departments.partials.scripts.datatable')
    @include('backend.departments.partials.scripts.modals')
    @include('backend.departments.partials.scripts.exports')
